...
public class WelcomePageController {
    ...
    public void doSelected(int selectedOption){
        switch(selectedOption){
            case 1: RegistrationController registrationController = RegistrationController.getInstance();
                    registrationController.showRegistrationView();
                    break;
            
            
            case 2: LoginController loginController = LoginController.getInstance();
